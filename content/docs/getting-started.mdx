...
<Tabs items={["pnpm", "npm", "yarn", "bun"]}>
  <Tab value="pnpm">```pnpm dlx shadcn@latest registry add @quiz-ui ```</Tab>
  <Tab value="npm">```npx shadcn@latest registry add @quiz-ui ```</Tab>
  <Tab value="yarn">```yarn dlx shadcn@latest registry add @quiz-ui ```</Tab>
  <Tab value="bun">```bunx --bun shadcn@latest registry add @quiz-ui ```</Tab>
</Tabs>
