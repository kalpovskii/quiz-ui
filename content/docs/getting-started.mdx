...
<CodeTabs>
  ```bash tab="pnpm" pnpm dlx shadcn@latest registry add @quiz-ui ``` ```bash
  tab="npm" npx shadcn@latest registry add @quiz-ui ``` ```bash tab="yarn" yarn
  dlx shadcn@latest registry add @quiz-ui ``` ```bash tab="bun" bunx --bun
  shadcn@latest registry add @quiz-ui ```
</CodeTabs>
